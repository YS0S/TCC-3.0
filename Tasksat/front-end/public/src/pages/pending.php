        ...
        <div class="flex flex-col w-4/5 bg-verde-50 h-fit p-3 gap-3 rounded-lg sm:flex-row sm:justify-between">
            <div class="flex flex-col gap-3 sm:flex-row sm:justify-start">
                <button id="ativar-selecao"
                    class="p-2 bg-verde-150 font-bold rounded-md text-black shadow-verde-250 shadow-sm hover:shadow-verde-250 hover:shadow-inner w-full sm:w-fit">
                    Selecionar
                </button>
        ...
        <div class="flex flex-col w-4/5 bg-verde-50 h-fit p-3 gap-3 rounded-lg">
            ...
            <div>
                <form method="GET" class="flex flex-col sm:flex-row gap-3">
                    ...
                    <button
                        class="w-full sm:w-fit p-2 bg-verde-150 font-bold rounded-md text-black shadow-verde-250 shadow-sm hover:shadow-verde-250 hover:shadow-inner"
                        type="submit">
                        Filtrar
                    </button>
                    ...
                    <a href="?filtro=<?= urlencode($filtro) ?>&subfiltro=<?= urlencode($subfiltro) ?>">
                        <button
                            class="w-full sm:w-fit h-full sm:h-fit p-2 bg-verde-150 font-bold rounded-md text-black shadow-verde-250 shadow-sm hover:shadow-verde-250 hover:shadow-inner"
                            type="button">
                            Limpar
                        </button>
                    </a>
                ...
                <div class="flex flex-col sm:flex-row gap-3 mt-3">
                    <a href="?filtro=todos">
                        <button
                            class="w-full sm:w-fit p-2 bg-verde-150 font-bold rounded-md text-black border-2 border-verde-250 hover:bg-verde-250 hover:text-black <?= $filtro == 'todos' ? 'active' : '' ?>">
                    ...
                    <div class="dropdown">
                        <button
                            class="w-full sm:w-fit text-black <?= $filtro == 'finalizados' ? 'active' : '' ?>">
                            Finalizados (<?= $contagens['finalizados'] ?>)
                        </button>

                        <div class="dropdown-content">
                            <a href="?filtro=finalizados&subfiltro=todos" class="text-black">
                                Todos (<?= $contagens['finalizados'] ?>)
                            </a>

                            <a href="?filtro=finalizados&subfiltro=cancelados" class="text-black">
                                Cancelados (<?= $contagens['cancelados'] ?>)
                            </a>

                            <a href="?filtro=finalizados&subfiltro=concluidos" class="text-black">
                ...
                <div class="flex flex-col sm:flex-row gap-3 mt-3">
                    ...
                    <a href="?filtro=aguardando_analise">
                        <button
                            class="w-full sm:w-fit p-2 bg-verde-150 font-bold rounded-md text-black border-2 border-verde-250 hover:bg-verde-250 hover:text-black <?= $filtro == 'aguardando_analise' ? 'active' : '' ?>">
                    ...
                    <a href="?filtro=aguardando_resolucao">
                        <button
                            class="w-full sm:w-fit p-2 bg-verde-150 font-bold rounded-md text-black border-2 border-verde-250 hover:bg-verde-250 hover:text-black <?= $filtro == 'aguardando_resolucao' ? 'active' : '' ?>">
                            ...
                            <div class="p-3">
                                ...
                                <div class="flex gap-2 mt-3">
                                    ...
                                    <a href="/Tasksat/front-end/public/src/pages/detail.php?id=<?= $id ?>"
                                        class="flex-1 text-center py-2 px-2 bg-verde-250 border border-verde-150 rounded text-sm font-semibold text-black hover:bg-verde-300">
                                        Acompanhar
                                    </a>
