...
<form method="POST" 
  ...
  <div class="p-2 grid sm:grid-cols-3 m-8 mt-0 size-fit sm:w-3/4 justify-self-center">
    ...
    <!-- FORM CAMPOS (ÁREA ALTERADA — COR MAIS CLARA) -->
    <div class="grid bg-verde-100 p-3 place-content-start rounded-2xl max-sm:rounded-t-none sm:rounded-l-none sm:col-span-2 gap-3">
